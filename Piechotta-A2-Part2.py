...
# Set fit-type (exponential, power, logarithmic or polynomial) by uncommenting desired type
fitType = "Exponential"
#fitType = "Power"
#fitType = "Logarithmic"
#fitType = "Polynomial"
...
# a) Enter data for two lists (x values for salinity and y values for voltage)
x = [0.0000004, 0.004, 0.008, 0.012, 0.016, 0.020, 0.024, 0.028, 0.032, 0.036, 0.040, 0.044, 0.048]
y = [2.19, 2.27, 2.37, 2.45, 2.48, 2.52, 2.55, 2.58, 2.60, 2.63, 2.65, 2.66, 2.66]
...
def plot(fitTypeInput):
    ...
    if fitTypeInput == "Exponential":
        ...
        if kValue < 2:
            print("k-Value must be greater than 1. Please set k-Value on Line 481.")
            sys.exit()
        ...
        print("Invalid 'fit-type'. Please set 'fit-type' on Lines 475-478 (exponential, power, logarithmic or polynomial).")
        sys.exit()
    ...
    # Source: https://stackoverflow.com/questions/22642511/change-y-range-to-start-from-0-with-matplotlib
    f, ax = plt.subplots(1)
...
def main():
    # c) Plots the data using the pyplot library in matplotlib with the following data on the plot:
